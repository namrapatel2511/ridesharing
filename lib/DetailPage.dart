...
class _DetailPageState extends State<DetailPage> {
  ...
  String endLocation = ''; // Initialize endLocation
  bool isLocationLoading = false; // Track location loading state

  @override
  void initState() {
    super.initState();
    // Initialize Firestore references using widget properties
    rideDocRef =
        FirebaseFirestore.instance.collection('rides').doc(widget.rideId);

    // Fetch endLocation from Firestore
    fetchEndLocation();
    getLocation();
  }
  ...
  Future<void> getLocation() async {
    setState(() {
      isLocationLoading = true; // Set location loading to true while fetching
    });
    ...
    try {
      ...
      setState(() {
        ...
        isLocationLoading = false; // Set location loading to false when loaded
      });
    } catch (e) {
      print('Error getting location: $e');
      setState(() {
        isLocationLoading =
            false; // Set location loading to false if error occurs
      });
    }
  }
              ...
              onPressed: () {
                if (currentLocation != null) {
                  openGoogleMapsNavigation(
                      ...
                      endLocation); // Use fetched endLocation
                } else {
